...
<div class="container">
	<div class="row">
		...
		<img src="img/title-image1.png"><br>
		 <h2 class="heading">BUILD YOUR OWN PACKAGE</h2>
		</div> 
		</div>
	<div class="row">
		<div class="col-sm-12">
            ...
            <tbody>
              ...
              <tr>
                <td>Basic Interior Cleaning</td>
                <td>$35</td>
                <td>$45</td>
                <td>$55</td>
              </tr>
              <tr>
                <td>One Time Exterior Wash</td>
                <td>$38</td>
                <td>$48</td>
                <td></td>
              </tr>
            ...
            <tbody>
              <tr>
                <td>Wax</td>
                <td>General Wax $70</td>
                <td>Special Shining Wax $130</td>
              ...
              <tr>
                <td>Heavy Duty Fee (extra large car or super dirty)</td>
                <td>$20</td>
                <td></td>
                <td></td>
              </tr>
